class BoxfileController < ApplicationController
    ...
    def upload
        begin
          ...
          redirect_to boxfile_path, :notice => "Your file was successfully uploaded to your T7Box"
        rescue
          redirect_to boxfile_path, :error => "Your file couldn't be uploaded to your T7Box"
        end
    end
